...
%>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-12 col-md-8 col-sm-6">
                                                ...
                                                <form id="form-book" class="form-container" style="background: rgba(255, 255, 255, 0.8)" action="bookflight" method="post">

                                                    <h2 class="text-center py-4 text-dark banner-heading font-weight-bold">Journey Details
                                                    </h2>
        	...
        	%>
        		...
        		%>
								...
								<% } }%>
                                                                        ...
                                                                        <div class="form-group has-feedback pl-5 ml-5">
                                                                            <label for="Dest" class="text-dark font-weight-bold">To</label> <select class="form-control" id="Dest" name="destination">
								<option selected value="selected">Select</option>
								<% 
        		if(codeList.size() != 0){
        			for(String code: codeList){
        		...
        		%>
							...
							Date</label> <input name="traveldate" type="date" class="form-control" id="travel_date" value=<%=d ateStr %> min=
                                                                        <%= dateStr %> />
							...
							Of Travellers</label> <input name="passengers" type="number" class="form-control " placeholder="Enter No of Travellers" id="passengers_no">
                                                                        <div class="invalid-feedback font-weight-bold" id="tError"></div>
                                                                    </div>


                                                                    <div class="form-group mt-4 has-feedback">
                                                                        <button type="button" class="btn btn-success btn-block " id="searchbtn">Search Flights</button>
                                                                    </div>
