                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-6 col-sm-6">
                                    ...
                                    <form class="form-container" id="password-form" style="background: rgba(255, 255, 255, 0.8)" action="updatepassword" method="post">
							...
							Id</label> <input name="customerid" type="text" class="form-control" id="customer-id" value=<%=c ustomer.getCustomerId() %> readonly />
                                            <div class="invalid-feedback font-weight-bold" id="uError"></div>
                                        </div>

                                        <div class="form-group has-feedback">
                                            <label for="email-id" class="text-dark font-weight-bold">Email
							Address</label> <input name="emailaddress" type="email" class="form-control" id="email-id" value=<%=c ustomer.getEmail() %> readonly />
                                        ...
                                        <div class="form-group mb-3 has-feedback">
                                            ...
                                            <input name="password" type="password" class="form-control" id="inputPassword4" placeholder="Enter New Password">
