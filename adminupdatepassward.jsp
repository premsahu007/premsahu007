				...
				<span class="navbar-toggler-icon"></span>
                            ...
                            <div class="collapse navbar-collapse " id="navbarResponsive">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item"><a href="admindetails.jsp" class="nav-link">Admin Details</a></li>
                                    <li class="nav-item"><a href="adminupdatepassword.jsp" class="nav-link">Change Password</a></li>
                                    <li class="nav-item"><a class="text-uppercase text-center p-1 nav-link" href="Logout"><i
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-6 col-sm-6">
                                    ...
                                    <form class="form-container" id="password-form" style="background: rgba(255, 255, 255, 0.8)" action="adminupdatepassword" method="post">
                                        <h3 class="text-center py-4 text-dark banner-heading font-weight-bold">Update Password Form</h3>

                                        <div class="form-group has-feedback">
                                            <label for="customer-id" class="text-dark font-weight-bold">Admin
							Id</label> <input name="customerid" type="text" class="form-control" id="customer-id" value=<%=a dm.getAdminId() %> readonly />
                                            <div class="invalid-feedback font-weight-bold" id="uError"></div>
                                        </div>

                                        <div class="form-group has-feedback">
                                            <label for="email-id" class="text-dark font-weight-bold">Email
							Address</label> <input name="emailaddress" type="email" class="form-control" id="email-id" value=<%=a dm.getEmail() %> readonly />
							...
							Password</label> <input name="password" type="password" class="form-control" id="inputPassword4" placeholder="Enter New Password">
                                            <div class="invalid-feedback font-weight-bold" id="pError"></div>
                                        </div>

                                        <button type="button" class="btn btn-primary btn-block " id="passbtn">Change Password</button>
                        ...
                        <footer>
                            <div class="row justify-content-center">
                                <div class="col-md-5 text-center">
                                    ...
                                    <p>Here at Fly Away we provide flights at the cheapest rate to help you reach your destination</p>
                                    <strong>Contact Info</strong>
                                    <p>
                                        <i class="fas fa-phone-square pr-2 fa-2x text-success"></i>{888} 888-8888
                                    </p>
                                    <p>
