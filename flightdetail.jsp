         ...
         for(Flight f: flightList){
  		 %>
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td class="py-3">
                                                                            <form action="showfaredetails" method="post">
                                                                                <input name="flightnumber" value="<%= f.getFlightNumber() %>" type="hidden"> <input class="btn btn-primary" type="submit" value="Book Tickets" />
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                                    <%} }%>
