...
%>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-12 col-md-6 col-sm-6">
                                        <form class="form-container" id="fare-form" style="background: rgba(255, 255, 255, 0.8)" action="addfaredetails" method="post">
                                            <h3 class="text-center py-4 text-dark banner-heading font-weight-bold">Add Fare Details</h3>

                                            <div class="form-group has-feedback">
                                                <label for="flightId" class="text-dark font-weight-bold">Flight
							Number</label> <input name="flightnumber" type="text" class="form-control" id="flightId" value=<%=f lightNumber %> readonly />
                                                <div class="invalid-feedback font-weight-bold" id="fError"></div>
                                            </div>

                                            <div class="form-group has-feedback">
                                                <label for="travelClass" class="text-dark font-weight-bold">Travel
							Class</label> <select class="form-control" id="travelClass" name="travelclass">
        		...
        		%>
							...
							Fare</label> <input name="fare" type="number" class="form-control " placeholder="Enter Class Fare" id="Fare" min=1 />
                                                <div class="invalid-feedback font-weight-bold" id="tError"></div>
                                            </div>


                                            <button type="button" class="btn btn-primary btn-block " id="farebtn">Add Fare</button>
