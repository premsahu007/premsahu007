				...
				<span class="navbar-toggler-icon"></span>
                                        ...
                                        <div class="collapse navbar-collapse " id="navbarResponsive">
                                            <ul class="navbar-nav ml-auto">
                                                <li class="nav-item"><a href="customerdetails.jsp" class="nav-link">Customer Details</a></li>
...
%>
                ...
                if(success != null){		
        	%>
                                            <div class="alert alert-success alert-dismissible fade show text-center font-weight-bold mt-5" role="alert">
                                                <%= success %>
                ...
                if(fail != null){		
        %>
                                                    <div class="alert alert-danger alert-dismissible fade show text-center font-weight-bold mt-5" role="alert">
                                                        <%= fail %>
				...
				<span aria-hidden="true">&times;</span>
                                                    ...
                                                    <%}%>
                                                        ...
                                                        <div class="btn-group mt-5 pt-5" role="group" aria-label="Basic example">
                                                            <a href="bookflight.jsp" class="btn btn-primary pl-3 ml-3">Book
				a new Journey</a> <a href="changepassword.jsp" class="btn btn-primary px-4 mx-4 ">Change Password</a>
                                                        </div>
	...
	if(reservationList.size() == 0){ %>
                                                            ...
                                                            <div class="alert alert-danger text-center text-uppercase text-primary font-weight-bold" role="alert">You have not done any Reservations Yet.</div>

                                                            <%}else if(reservationList.size() != 0){ %>

                                                                <h2 class="text-center text-uppercase text-primary font-weight-bold">All Booking Details</h2>
                                                                <div class="container p-5 m-5 text-center">
                                                                    <table id="BasicExample" class="table table-striped table-hover table-light table-bordered">
