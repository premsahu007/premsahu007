...
%>
				...
				<span class="navbar-toggler-icon"></span>
							...
							class="fas fa-sign-out-alt fa-2x pr-1 "></i> logout</a></li>
                                    ...
                                    <h2 class="text-center text-uppercase text-primary font-weight-bold pt-5 mt-5">Booking Details
                                    </h2>
                                        ...
                                        <%}%>
                                            ...
                                            <div class="container jumbotron py-2">
                                                ...
                                                <form class="pb-3" action="confirmbooking" method="post">
                                                    <input class="btn btn-primary btn-block" type="submit" value="Confirm Booking" />
                                                </form>
                                            </div>
