...
%>
	...
	%>
			...
			a new Journey</a>
                                            ...
                                            <h2 class="text-center text-uppercase text-primary font-weight-bold pt-3 mt-3">Ticket Details
                                            </h2>
                                            ...
                                            <div class="container jumbotron py-2">
                                                ...
                                                <input type="submit" class="btn btn-primary btn-block" value="Print Ticket" name="download" onclick="window.print()" />
