        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-sm-6">
                    <form class="form-container" id="login-form" style="background: rgba(255, 255, 255, 0.8)" action="adminlogin" method="post">
                        <h3 class="text-center py-4 text-dark banner-heading font-weight-bold">Admin Login Form</h3>
        	...
        	%>
							...
							Address</label> <input name="emailaddress" type="email" class="form-control" placeholder=" Enter Email Address" id="email-id" />
